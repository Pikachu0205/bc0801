...
app.post('/Height',upload.array(), function(req, res) {
	...
	concole.log("req.body.height : " + req.body.height);
	concole.log("height : " + height);
...
app.post('/Vote', function(req, res) {
	if(myMain.customVerify(req.body)  &&  height > 0){
		...
		//if( commitBlock ==null && ((mode == "t"  &&  feedbackVote.length == 4*fault+1) || (mode == "m"  &&  feedbackVote.length == 2*fault+1)) ){
